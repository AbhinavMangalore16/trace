  ...
  return (
    <section className="py-24 px-6 bg-slate-950">
      <div className="mx-auto max-w-7xl text-slate-100">
        {/* Header */}
        <ScrollReveal direction="up" distance={30} className="mb-14 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <div>
            ...
            <h2 className="mt-3 max-w-2xl text-4xl font-extrabold tracking-wide text-white md:text-5xl font-cal leading-tight">
        ...
        <div className="mb-6 grid grid-cols-12 gap-6">
          <ScrollReveal direction="up" delay={0.1} className="col-span-12 md:col-span-4">
            <BounceCard accentClassName="from-sky-500 to-cyan-500">
              <CardTitle
          ...
          <ScrollReveal direction="up" delay={0.2} className="col-span-12 md:col-span-8">
            <BounceCard accentClassName="from-amber-400 to-orange-500">
              <CardTitle
        ...
        {/* Row 2 */}
        <div className="mb-6 grid grid-cols-12 gap-6">
          <ScrollReveal direction="up" delay={0.1} className="col-span-12 md:col-span-8">
            <BounceCard accentClassName="from-emerald-500 to-green-600">
              <CardTitle
          ...
          <ScrollReveal direction="up" delay={0.2} className="col-span-12 md:col-span-4">
            <BounceCard accentClassName="from-rose-500 to-red-600">
              <CardTitle
        ...
        <div className="grid grid-cols-12 gap-6">
          <ScrollReveal direction="up" delay={0.1} className="col-span-12 md:col-span-4">
            <BounceCard accentClassName="from-purple-500 to-indigo-600">
              <CardTitle
          ...
          <ScrollReveal direction="up" delay={0.2} className="col-span-12 md:col-span-4">
            <BounceCard accentClassName="from-zinc-500 to-slate-700">
              <CardTitle
          ...
          <ScrollReveal direction="up" delay={0.3} className="col-span-12 md:col-span-4">
            <BounceCard accentClassName="from-blue-500 to-indigo-600">
              <CardTitle
...
function BounceCard({ className = "", children, accentClassName }: BounceCardProps) {
  return (
    <motion.div
      ...
      className={`group relative min-h-80 cursor-pointer overflow-hidden rounded-3xl border border-slate-800/80 bg-[#0c1229] p-7 pb-36 shadow-lg w-full ${className}`}
    >
      {children}
      <div
        aria-hidden
...
function CardTitle({ title, subtitle, stat }: CardTitleProps) {
  return (
    <div className="relative z-20 space-y-2">
      ...
      <h3 className="text-2xl font-bold tracking-wide text-white font-cal">
        {title}
      </h3>
      {subtitle && (
