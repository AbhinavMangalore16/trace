  ...
  return (
    <section className="py-24 px-6 bg-slate-950 text-slate-100">
      <div className="mx-auto max-w-6xl">
        {/* Header */}
        <ScrollReveal direction="up" className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-10 pb-6 border-b border-white/10">
          <div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-wide font-cal">
              Our Pricing
            </h2>
          ...
          <div className="flex items-center gap-3 text-xs font-semibold">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${isAnnual ? "bg-blue-600" : "bg-slate-800"
                }`}
            >
              <span
                className={`inline-block size-4 transform rounded-full bg-white transition-transform ${isAnnual ? "translate-x-6" : "translate-x-1"
                  }`}
              />
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <ScrollReveal direction="up" delay={0.1}>
            <div className="rounded-2xl border border-white/10 bg-[#0c1020] p-6 flex flex-col justify-between shadow-lg h-full">
              <div>
          ...
          <ScrollReveal direction="up" delay={0.2}>
            <div className="rounded-2xl border border-cyan-500/30 bg-[#0c1020] p-6 flex flex-col justify-between shadow-lg relative h-full">
              <div>
          ...
          <ScrollReveal direction="up" delay={0.3}>
            <div className="rounded-2xl border border-yellow-500/30 bg-[#0c1020] p-6 flex flex-col justify-between shadow-lg h-full">
              <div>
