...
export const DominoRegistry = {
    ...
    //         { path: "result", label: "Action Result" },
    //     ],
    // },
    // "extract": {
    //     type: "extract",
    ...
    //     ],
    //     outputs: [
    //         { path: "data", label: "Extracted Data" },
    //     ],
    // },
    // "observe": {
    //     type: "observe",
    ...
    //     ],
    //     outputs: [
    //         { path: "elements", label: "Observed Elements" },
    //     ],
    // },
    // "agent": {
    //     type: "agent",
    ...
    //     ],
    //     outputs: [
    //         { path: "result", label: "Agent Output" },
    //     ],
    // },
    // "scroll": {
    //     type: "scroll",
    ...
    //     ],
    //     outputs: [
    //         { path: "solved", label: "Solved Status" },
    //     ],
    // },
    // "screenshot": {
    //     type: "screenshot",
    ...
    //     ],
    //     outputs: [
    //         { path: "result", label: "Condition Met" },
    //     ],
    // },
    // "loop-items": {
    //     type: "loop-items",
    ...
    //     ],
    //     outputs: [
    //         { path: "result", label: "Transformed Result" },
    //     ],
    // },
    ...
    //     ],
    //     outputs: [
    //         { path: "filePath", label: "File Path / URL" },
    //     ],
    // }
...
export type ActionDominoType = { [K in DominoType]: (typeof DominoRegistry)[K]["kind"] extends "action" ? K : never }[DominoType]