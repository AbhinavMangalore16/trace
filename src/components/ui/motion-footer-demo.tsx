...
export default function MotionFooterDemo() {
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden bg-background font-sans selection:bg-white/20">
      <main className="relative z-10 flex min-h-[120vh] w-full flex-col items-center justify-center rounded-b-3xl border-b border-white/10 bg-background text-white shadow-[0_20px_60px_rgba(0,0,0,0.25)]">
