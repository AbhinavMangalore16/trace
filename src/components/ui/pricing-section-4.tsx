      ...
      <div className="relative z-10 mx-auto flex w-fit rounded-full border border-gray-700 bg-neutral-900 p-1">
        ...
        >
          {selected === "0" && (
            <motion.span
              layoutId="switch"
              className="absolute left-0 top-0 h-10 w-full rounded-full border-4 border-blue-600 bg-linear-to-t from-blue-500 to-blue-600 shadow-sm shadow-blue-600"
        ...
        <button
          ...
          className={cn(
            "relative z-10 h-10 w-fit shrink-0 rounded-full px-3 py-1 font-medium transition-colors sm:px-6 sm:py-2",
  ...
  return (
    ...
    >
      ...
      <TimelineContent
        ...
        timelineRef={pricingRef}
        customVariants={revealVariants}
        className="absolute left-0 -top-28.5 z-0 flex h-[113.625vh] w-full flex-none flex-col flex-nowrap content-start items-start justify-start gap-2.5 overflow-hidden p-0"
      >
        <div className="framer-1i5axl2">
          <div
            className="absolute -left-142 -right-142 top-0 h-513.25 flex-none rounded-full"
            style={{
      ...
      <article className="relative z-50 mx-auto mb-6 w-full max-w-4xl space-y-2 px-4 pt-32 text-center sm:px-6 lg:px-8">
      ...
      <div
        className="absolute left-[10%] top-0 z-0 h-full w-[80%] right-[10%]"
        style={{
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-4 px-4 py-6 sm:px-6 md:grid-cols-3 lg:px-8">
        {plans.map((plan, index) => (
          ...
          >
            <Card
              className={cn(
                "relative h-full w-full border-neutral-800 text-white",
                plan.popular
                  ? "z-20 bg-linear-to-r from-neutral-900 via-neutral-800 to-neutral-900 shadow-[0px_-13px_300px_0px_#0900ff]"
                  : "z-10 bg-linear-to-r from-neutral-900 via-neutral-800 to-neutral-900",
              )}
            >
              ...
              <CardContent className="pt-0">
                <button
                  className={cn(
                    ...
                    plan.popular
                      ? "border border-blue-500 bg-linear-to-t from-blue-500 to-blue-600 text-white shadow-lg shadow-blue-800"
                      : plan.buttonVariant === "outline"
                        ? "border border-neutral-800 bg-linear-to-t from-neutral-950 to-neutral-600 text-white shadow-lg shadow-neutral-900"
                        : "",
                  )}
                >
                  {plan.buttonText}
